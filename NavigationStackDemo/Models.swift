...
struct Country: Hashable, Identifiable {
    ...
    static var countries: [Country] {
        [
            Country(name: "Canada", flag: "🇨🇦", population: 36991981, cities: City.cities.filter { $0.country == "Canada" }),
            Country(name: "United States", flag: "🇺🇸", population: 332278200, cities: City.cities.filter { $0.country == "United States" }),
            Country(name: "United Kingdom", flag: "🇬🇧", population: 67886004, cities: City.cities.filter { $0.country == "United Kingdom" }),
            Country(name: "France", flag: "🇫🇷", population: 67413000, cities: City.cities.filter { $0.country == "France" }),
            Country(name: "Mexico", flag: "🇲🇽", population: 128830, cities:  City.cities.filter { $0.country == "Mexico" }),
        ]
    }
}
